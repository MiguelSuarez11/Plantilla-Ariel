        ...
        <!-- Sección de formulario -->
         <div class="w-1/2 flex justify-center rounded-2xl items-center ml-3 mt-3 bg-white" style=" height: 600px; max-width: 800px; ">
            <div class="bg-white  rounded-lg p-8" style="width: 100%; max-width: 800px;">
                ...
                <p class="text-gray-600 text-base mt-4 mb-5">¿No tienes cuenta? <a href="#" class="text-blue-600">Crea una cuenta</a></p>

                <form>
                    <div class="mb-4">
                        <label for="email" class="block text-gray-700 text-sm font-semibold mb-2">Email</label>
                        <input type="email" id="email" placeholder="Email" class="w-full px-4 py-2 border rounded-md focus:outline-none focus:ring-2 focus:ring-blue-500 focus:border-transparent"/>
                    </div>
                    <div class="mb-6">
                        <label for="password" class="block text-gray-700 text-sm font-semibold mb-2">Contraseña</label>
                        <input type="password" id="password" placeholder="Contraseña" class="w-full px-4 py-2 border rounded-md focus:outline-none focus:ring-2 focus:ring-blue-500 focus:border-transparent"/>
                    </div>
                    <div class="flex items-center justify-end mb-6">
                        <a href="#" class="text-blue-600 text-sm">Recuperar contraseña</a>
                    </div>
