...
<body class = "body bg-slate-300 dark:bg-[#0F172A]">
    ...
    <!-- CONTENT -->
    <div class = "content ml-12 transform ease-in-out duration-500 pt-2 px-2 md:px-5 pb-4 ">
        ...
        {{-- Tarjeta d chat --}}
        <div class=" logo flex-1 flex flex-col justify-center items-center pb-6  bg-white rounded-2xl shadow-2xl">
