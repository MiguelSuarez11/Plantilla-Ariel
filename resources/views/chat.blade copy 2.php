...
<body class = "body bg-slate-100 dark:bg-[#ffffff]">
    <aside
        class = "w-60 -translate-x-48 fixed transition transform ease-in-out duration-1000 z-50 flex h-screen bg-slate-100 ">
        <!-- open sidebar button -->

        <div onclick="openNav()"
            class = "-right-1 transition transform ease-in-out duration-500 flex border-4 border-white dark:border-[#0F172A] bg-[#1E293B] dark:hover:bg-blue-500 hover:bg-purple-500 absolute top-2 p-3 rounded-full text-white hover:rotate-45">
        ...
        <div class= "max hidden text-white mt-20 flex-col space-y-2 w-full h-[calc(100vh)]">
            ...
            {{-- Logo --}}
            <div class="ml-9 mb-8">
                <img src="https://app.arielapp.co/assets/dashboard/brand-logo-and-name.svg" alt="Logo Ariel"
                    class="w-24">
            </div>
    ...
    <!-- CONTENT -->
    <div class = "content ml-12 transform ease-in-out duration-500 pt- px-2 md:px-5 pb-4 ">





        <div class="flex-1 flex flex-col justify-center items-center pb-6  bg-white rounded-2xl shadow-2xl">

            <!-- Barra de navegación superior centrada y ocupando todo el ancho -->
            <div class="w-full flex justify-center bg-white rounded-t-3xl py-2 border-b border-gray-300 ">
                <div class="flex justify-center space-x-8">
                    <button id="legalTab"
                        class="px-6 py-2 text-gray-700 font-medium focus:outline-none hover:text-blue-500"
            ...
            <div class="text-center mt-6 w-full max-w-3xl" id="chatContent">
                <!-- Aquí se mostrará el contenido dinámico basado en el tab seleccionado -->
                <div id="legal" class="tabContent">
                    <img src="https://www.4b3ce87ca580ariel4bb7947a263be0850b58.net/assets/logofull-4b2354b7.png"
                        alt="Imagen Ariel" class="w-80 mx-auto mb-6">
                    <h1 class="text-4xl font-bold text-gray-800">Ariel - Asistente Legal</h1>
                    <p class="text-lg text-gray-600 mt-4">Analiza miles de normas, jurisprudencia y doctrina legal
                        especializada.
                ...
                <div id="empresarial" class="tabContent hidden">
                    ...
                    <p class="text-lg text-gray-600 mt-4">Brinda soporte en temas empresariales como estrategia,
                        operaciones, y
                ...
                <div id="redaccion" class="tabContent hidden">
                    ...
                    <p class="text-lg text-gray-600 mt-4">Asiste en la creación y edición de documentos jurídicos,
                        empresariales o
                        técnicos. Solicita revisiones de texto o genera nuevos documentos en base a tus necesidades.</p>
                </div>


                <div id="preguntas" class="mt-6 flex flex-col space-y-4">
                    <button class="px-4 py-2 border border-cyan-500 text-black rounded-3xl">¿Qué diferencia a Ariel de
                        otros chatbots inteligentes?</button>
                    <button class="px-4 py-2 border border-cyan-500 text-black rounded-3xl">¿Cómo puedo empezar a usar
                        Ariel?</button>
                    <button class="px-4 py-2 border border-cyan-500 text-black rounded-3xl">¿En qué áreas del derecho
